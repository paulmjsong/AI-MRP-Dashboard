...
export default function Page2({ kpi, forecast, lastUpdate }: PageProps) {
  ...
  return (
    <>
      ...
      {/* 메인 콘텐츠 탭 */}
      <Tabs defaultValue="filterBOM" className="space-y-6">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="filterBOM">Filter BOM</TabsTrigger>
          <TabsTrigger value="consumBOM">Consumable BOM</TabsTrigger>
        </TabsList>

        {/* Filter Forecast 탭 */}
        <TabsContent value="filterBOM" className="space-y-6">
          <Card>
            <CardHeader>
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  <CardTitle>Filter BOM</CardTitle>
        ...
        {/* Consumable 탭 */}
        <TabsContent value="consumBOM" className="space-y-6">
          <Card>
            <CardHeader>
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  <CardTitle>Consumable BOM</CardTitle>
                  <CardDescription>제품별 BOM 정보 조회</CardDescription>
                </div>
                <div className="flex items-center gap-2">
                  {/* <div className="relative">
